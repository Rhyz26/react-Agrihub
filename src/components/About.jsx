...
function About () {
  return (
    <div>
      <h1 className='text-center pb-3 pt-3 text-3xl'>Welcome to AgriHub</h1>
      <p className='mx-auto max-w-[40%] text-center'>Welcome to AgriHub, where our passion for agriculture drives us to deliver innovative and sustainable solutions. Founded in 2024, we are committed to connecting farmers, their produce, and vendors to markets using advanced transportation and logistics.

</p>

<h1 className='text-center pb-3 pt-3 text-3xl'>Our Mission</h1>
<p className='mx-auto max-w-[40%] text-center'>Our mission at AgriHub is to empower farmers with the tools and resources they need to thrive in a competitive market. We strive to enhance agricultural productivity and ensure that high-quality produce reaches consumers efficiently and affordably.</p>

<h1 className='text-center pb-3 pt-3 text-3xl'>Our Vision</h1>
<p className='mx-auto max-w-[40%] text-center'>We envision a world where agriculture is sustainable, efficient, and accessible to all. Our goal is to be a leading force in transforming the agricultural landscape through innovation and collaboration.
...
<h1 className='text-center pb-3 pt-3 text-3xl'>Our Values</h1>
<h1 className='text-center'>At AgriHub, we are guided by a set of core values:</h1>
<p className='text-center'>Sustainability: We are committed to promoting sustainable agricultural practices.</p>
<p className='text-center'>Innovation: We continuously seek innovative solutions to address agricultural challenges.</p>
<p className='text-center'>Community: We believe in supporting and uplifting the communities we serve.
</p>
